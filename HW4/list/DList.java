...
public class DList {
  ...
  public void insertFront(Object item) {
    if (this.size != 0) {
      DListNode addNode = newNode(item, this.head, this.head.next);
      this.head.next.prev = addNode;
      this.head.next = addNode;
      this.size++;
    } else {
      DListNode addNode = newNode(item, this.head, this.head);
      this.head.next = addNode;
  ...
  public void insertBack(Object item) {
    if (this.size != 0) {
      DListNode addNode = newNode(item, this.head.prev, this.head);
