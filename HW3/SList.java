...
public class SList {
  ...
  public void squish() {
    ...
    if (head != null) {
      while (curNode != null && curNode.next != null) {
        Object currentValue = curNode.item;
        SListNode thisNode = curNode;
        while (thisNode != null && thisNode.item.equals(currentValue)) {
  ...
  **/
  ...
  public void reverse() {
    ...
    SListNode curNode = head;
    SListNode newNode = curNode.next;
    SListNode oldNode = null;
    if (head != null) {
      while (curNode != null) {
