...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DList thisList = (DList) this.myList;
    DListNode addNode = thisList.newNode(item, thisList, this, this.next);
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   new node.
    DList thisList = (DList) this.myList;
    DListNode addNode = thisList.newNode(item, thisList, this.prev, this);
  ...
  public void remove() throws InvalidNodeException {
    ...
    DListNode tempNode = this;
    this.prev.next = tempNode.next;
    this.next.prev = tempNode.prev;
