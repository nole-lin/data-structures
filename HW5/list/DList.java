...
public class DList extends List {
   ...
   **/
  public DList() {
    this.head = newNode(Integer.MIN_VALUE, null, this.head, this.head);
  ...
  public void insertFront(Object item) {
    if (this.size != 0) {
      DList exampleList = (DList) head.next.myList;
      DListNode addNode = newNode(item, exampleList, this.head, this.head.next);
      this.head.next.prev = addNode;
      this.head.next = addNode;
      this.size++;
    } else {
      DList l = new DList();
      DListNode addNode = newNode(item, l, this.head, this.head);
      this.head.next = addNode;
  ...
  public void insertBack(Object item) {
    if (this.size != 0) {
      DList exampleList = (DList) head.next.myList;
      DListNode addNode = newNode(item, exampleList, this.head.prev, this.head);
      this.head.prev.next = addNode;
      this.head.prev = addNode;
      this.size++;
    } else {
      DList l = new DList();
